...
class Blockchain:
    ...
    def chain_is_valid(self, chain):
            ...
            for i in range(1, len(chain)):
                ...
                print(block_hash)
                if block_hash[:4] != '0000' or block_hash != current_block['hash']: #
                    validChain = False

                if current_block['previous_hash'] != prev_block['hash']:
                # i가 1이 아니거나 현재 블럭의 previous_hash값과 이전 블럭의 hash값이 같은지 비교:
                    validChain = False
